...
const data = [
  { line1: "50,183.82", line2: "Balance" },
  { line1: "$53.44", line2: "Net P/L" },
  { line1: "$53.44", line2: "Floating" },
    ...
    <Grid container style={{ margin: 15 }}>
      ...
      >
        ...
        {mobileDisplay ? null : (
          <>
            <Grid item>
              <Typography variant="h2" color="#31A060">
                {"402.70%"}
              </Typography>
            </Grid>
            <Grid item>
      ...
      <Grid
        ...
        style={{
          alignItems: "center",
          marginBottom: 5,
          justifyContent: mobileDisplay ? "center" : "flex-start",
        }}
      >
        <Typography variant="P2" color="#31A060">
          {"Read more"}
        </Typography>
        <IconButton
          onClick={handleClick}
        ...
        {open ? (
          <Grid container variant="body1">
            open text....
          </Grid>
        ) : null}
      </Grid>
      <Grid item container style={{ gap: "10px", width: "100%" }}>
        {data.map((item, id, row) => (
          <PaperItem
            key={id}
